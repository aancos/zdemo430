...
@EndUserText.label: 'CDS Empleados'
...
define view entity Z00_R_Employee as select from z00employ as Employee

association[1..1] to Z00_R_Department as _Department
