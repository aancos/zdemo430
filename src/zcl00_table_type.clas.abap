CLASS zcl00_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL00_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z00t_addresses.
...
DATA person TYPE z00s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE z00t_persons.
